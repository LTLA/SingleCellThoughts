...
This is a valid perspective but the presence of the additional colors becomes an unnecessary distraction, e.g., an uninteresting gene/cluster combination can manifest either as a large blue dot or a small dot dominated by background color.
The reader should not have to consider two different visualizations that have the same meaning.
