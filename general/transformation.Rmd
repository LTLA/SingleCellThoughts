...
There are several major issues in the example below -
 ...
 the loss of all variation at higher abundances,
 and 
...
(There is also some gain of expression in non-expressing cells, which is unusual for a transformation method.)
Of course, platelets are a rather extreme example, but one can imagine more subtle cases where biology is lost.
