...
In practice, cells with high mitochondrial proportions tend to have low total counts, so perhaps the biological effect is not so bad.
There's also no choice for data without spike-ins; a quick plot of mitochondrial proportions against the total count can verify that you're not removing obvious biology.
