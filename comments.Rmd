...
In practice, cells with high mitochondrial proportions tend to have low total counts, so perhaps the biology is not so pronounced in this metric.
...
However, I would only trust mitochondrial proportions if they aligned with the other metrics anyway.
