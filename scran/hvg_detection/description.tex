...
This is first performed for the spike-in transcripts, yielding $\sigma^2_{s,b}$ and $A_{s,b}$ for the sample variance and mean of spike-in $s$ in batch $b$.
...
It also protects against \textit{random} shifts in the average abundance of each spike-in transcript due to a batch effect.
...
One of the most common causes of differences in the trend is scaling normalization when the coverage of spike-in or endogenous genes differs systematically between batches.
